  ...
  React.useEffect(()=>{
   ...
   const isNumber = function (n) {
    ...
    const descriptions = [
      ...
      {name:"fuel_consumption",descp:"This tool will help us to do the calculation and conversions related to fuel consumption in MPG (US),MPG (imp), Km/Litre etc."},
      {name:"time",descp:"With the help of this tool we can convert from one unit to other, eg: nanoseconds , second , picosecond, millisecond etc."},
      ...
      {name:"current",descp:"This tool is used to convert between units,Abampere, Ampere ,Biot, Centiampere ,Coulomb per second etc."},
