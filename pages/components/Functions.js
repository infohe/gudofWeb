  ...
  const function_id = parseInt(id);
    const electricalList =[
      ...
      { display:"Effective Tension from Torque & Radius",descp:"Using this toolwe can find the Effective Tension from Torque and Radius.",id:69,q1:"Torque",qc1:"",q2:"Radius",qc2:"",a1:"Effective Tension",ac1:"lbs"},
        ...
        {display:"Cauchy Number",id:91,descp:"This tool is used to determine the Cauchy number and it can be calculated by using the inputs such as flow velocity, density and bulk modulus elasticity.        ",q1:"Flow Velocity",qc1:"m/s",q2:"Density",qc2:"kg/m^3",q3:"Bulk Modulus Elasticity",qc3:"N/m^2",a1:"Cauchy Number",ac1:""},
