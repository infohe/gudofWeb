...
export async function getStaticPaths() {
  ...
  export async function getStaticProps({ params }) {
    ...
    {display:"Gear Pump Displacement",id:81,type:"mechanical",category:"electrical"},
    {display:"Stroke's Law",id:82,type:"mechanical",category:"electrical"},
    {display:"Flow Velocity",id:83,type:"mechanical",category:"electrical"},
    {display:"Hooke's Law (Force)",id:84,type:"mechanical",category:"electrical"},
    {display:"Hooke's Law (Spring constant)",id:85,type:"mechanical",category:"electrical"},
    {display:"Strain",id:86,type:"mechanical",category:"electrical"},
    {display:"K Value & Pipe Length",id:87,type:"mechanical",category:"electrical"},
    {display:"Young's modulus",id:88,type:"mechanical",category:"electrical"},
    {display:"Weber Number",id:89,type:"mechanical",category:"electrical"},
    {display:"Chezy Coefficient",id:90,type:"mechanical",category:"electrical"},
    {display:"Cauchy Number",id:91,type:"mechanical",category:"electrical"},
    {display:"Bulk Modulus Elasticity",id:92,type:"mechanical",category:"electrical"},
